...
# <= меньше или равно
print(
    f'a({a.a}, {a.b}, S={a.area}) <= b({b.a}, {b.b}, S={b.area}) - {a <= b}')  # неявный вызов метода __le__, который дёрнет __eq__ и/или __lt__
print(
    f'a({a.a}, {a.b}, S={a.area}) <= c({c.a}, {c.b}, S={c.area}) - {a <= c}')  # неявный вызов метода __le__, который дёрнет __eq__ и/или __lt__
print('-----------------------------------------------------------------------')
...
print('-----------------------------------------------------------------------')
print(
    f'a({a.a}, {a.b}, S={a.area}) >= c({c.a}, {c.b}, S={c.area}) - {a >= c}')  # __ge__ -> __le__ -> __eq__, __lt__ не вызвался потому что __eq__ вернул True
print('-----------------------------------------------------------------------')
